...
using EmailSenderDemo.Repository.Services;
...
namespace EmailSenderDemo
{
    public class Startup
    {
        ...
        {
            services.AddScoped<MQ_Service>();
            services.AddSingleton<MQService>();
            services.AddSingleton<IEmailLogRepository, EmailLogRepository>();
            services.AddSingleton<IEmailLogRetryRepository, EmailLogRetryRepository>();
            services.AddSingleton<ApplicationNonSqlDbContext>();
